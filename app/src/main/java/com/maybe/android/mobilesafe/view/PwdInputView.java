...
public class PwdInputView extends RelativeLayout {
     ...
     * @param pwdsize           密码字体大小
     */
    private void initShowInput(int bgcolor, int pwdlength, float splilinewidth, int splilinecolor, int pwdcolor, int pwdsize) {
        //添加密码框父布局
        ...
        LinearLayout.LayoutParams params2 = new LinearLayout.LayoutParams(dip2px(context, splilinewidth),LayoutParams.MATCH_PARENT);
